...
export default function InsightsDashboard() {
  ...
  async function fetchCheckIns() {
    ...
    const res = await fetch(`https://56ff-102-39-173-168.ngrok-free.app/api/checkins/?start_date=${startDate.toISOString().split('T')[0]}&end_date=${endDate.toISOString().split('T')[0]}`, {
