...
export default function MyPactsPage() {
  ...
  const handleDelete = async (pactId) => {
    try {
      const response = await fetch(`https://e665-105-214-49-222.ngrok-free.app/api/pacts/${pactId}/`, {
        method: "DELETE",
        headers: {
  ...
  const handleUpdatePact = async () => {
    try {
      const response = await fetch(`https://e665-105-214-49-222.ngrok-free.app/api/pacts/${editingPact.id}/`, {
        method: "PATCH",
        headers: {
  ...
  const handlePauseToggle = async (pact) => {
    try {
      const response = await fetch(`https://e665-105-214-49-222.ngrok-free.app/api/pacts/${pact.id}/`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          Authorization: userToken,
      ...
      const statusResponse = await fetch("https://e665-105-214-49-222.ngrok-free.app/api/status-history/", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: userToken,
...
function CheckInButton({ pactId, choice, note, onCheckIn }) {
  ...
  const handleClick = async () => {
    ...
    try {
      ...
      await fetch("https://e665-105-214-49-222.ngrok-free.app/api/checkins/", {
        method: "POST",
        headers: {
          Authorization: token,
          "Content-Type": "application/json",
