...
export default function MyPactsPage() {
  ...
  const fetchPacts = async (token) => {
    try {
      setIsLoading(true)
      const res = await fetch("https://9de1-102-39-173-168.ngrok-free.app/api/pacts", {
  ...
  const handleDelete = async (pactId) => {
    try {
      const response = await fetch(`https://9de1-102-39-173-168.ngrok-free.app/api/pacts/${pactId}/`, {
        method: "DELETE",
        headers: {
  ...
  const handleUpdatePact = async () => {
    try {
      const response = await fetch(`https://9de1-102-39-173-168.ngrok-free.app/api/pacts/${editingPact.id}/`, {
        method: "PATCH",
        headers: {
  ...
  const handlePauseToggle = async (pact) => {
    try {
      const response = await fetch(`https://9de1-102-39-173-168.ngrok-free.app/api/pacts/${pact.id}/`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          Authorization: userToken,
      ...
      const statusResponse = await fetch("https://9de1-102-39-173-168.ngrok-free.app/api/status-history/", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: userToken,
...
function CheckInButton({ pactId, choice, note, onCheckIn }) {
  ...
  const handleClick = async () => {
    ...
    try {
      ...
      await fetch("https://9de1-102-39-173-168.ngrok-free.app/api/checkins/", {
        method: "POST",
        headers: {
          Authorization: token,
          "Content-Type": "application/json",
