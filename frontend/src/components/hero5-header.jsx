                    ...
                    <div
                        ...
                        <div
                            ...
                            <div
                                ...
                                <Button asChild size="sm" className={cn('bg-red-950 text-white hover:bg-red-900', isScrolled && 'lg:hidden')}>
                                    <Link to = "/register">
                                        <span>Sign up</span>
                                    </Link>
                                </Button>
                                <Button
                                    asChild
                                    size="sm"
                                    className={cn('bg-red-950 text-white hover:bg-red-900', isScrolled ? 'lg:inline-flex' : 'hidden')}>
